...
public class VNPAYController extends BaseService  {
    ...
    public ResponseEntity<?> createPayment(
        ...
        Contract contract = new Contract("Hợp đồng thanh toán online" + nameOfRent,null, nameOfRent, startDate, endDate ,getUsername(), getUsername(), room);
    ...
    public void sendEmailFromTemplate(String email, User user, Contract contract) throws MessagingException, IOException {
        ...
        htmlTemplate = htmlTemplate.replace("[Address]", "Hà Nội");
