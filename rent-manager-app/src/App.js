...
import BookingHomestay from './page/user/BookingHomestay';
import OrderSuccess from './common/OrderSuccess';
import OrderManagement from './page/rentaler/OrderManagement';
    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/booking-homestay/:id" element={<BookingHomestay authenticated={authenticated} currentUser={currentUser} onLogout={handleLogout} />} />
          <Route exact path="/ordered-success" element={<OrderSuccess authenticated={authenticated} currentUser={currentUser} onLogout={handleLogout} />} />
          ...
          <Route exact path="/ordered-success/:id" element={<OrderSuccess />} />
          ...
          <Route exact path="/rentaler/order-room-management" element={<OrderManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />} />
