            ...
            <div className="row">
              <div className="col-md-12 col-lg-8">
                <div className="title-single-box">
                  <h1 className="title-single">Nhà Trọ</h1>
                  <span className="color-text-a">Cho thuê Nhà Trọ</span>
                </div>
              </div>
                          ...
                          <div className="price-box d-flex">
                            <span className="price-a">
                              ...
                              {room.status === "CHECKED_OUT" &&
                                `Đã trả Phòng trọ | ${room.price.toLocaleString(
                                  "vi-VN",
                                  {
                                    style: "currency",
                                    currency: "VND",
