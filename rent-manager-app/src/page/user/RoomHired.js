                    ...
                    <div className="main">
                        ...
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title">Lịch sử thuê Phòng trọ</h5>
                                <h6 className="card-subtitle text-muted"> Hiển thị lịch sử thuê Phòng trọ.</h6>
                            </div>
                                        ...
                                        <tbody>
                                            {tableData.map((item) => (
                                                <tr className="odd">
                                                    ...
                                                    <td>{item?.endDate}</td>
                                                    <td style={{ color: "green" }}>{item.room.status === "ROOM_RENT" || item.room.status === "CHECKED_OUT" ? "Đã trả Phòng trọ" : "Đã thuê"}</td> <td>
