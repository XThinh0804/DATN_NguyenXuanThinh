                  ...
                  <div className="icon-box section-b2">
                    ...
                    <div className="icon-box-content table-cell">
                      ...
                      <div className="icon-box-content">
                        <p className="mb-1">
                          <span className="color-a">Địa chỉ :</span> số 3, ngách 112/12 Nguyên Xá,Bắc Từ Liêm, Thành phố Hà Nội
                        </p>
                        <p className="mb-1">
                          <span className="color-a">SĐT :</span> +84 984 955623
                        </p>
                        <p className="mb-1">
                          <span className="color-a">Email :</span> thinha4k54cma@gmail.com
                        </p>
                      </div>
                    </div>
                  </div>
