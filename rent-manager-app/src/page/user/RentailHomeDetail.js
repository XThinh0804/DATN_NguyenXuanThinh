                        ...
                        <div class="summary-list">
                          <ul class="list">
                            ...
                            <li class="d-flex justify-content-between">
                              ...
                              <span>{rooms && rooms.location.cityName}</span>
                            </li>
                            {rooms &&
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="property-agent">
                        ...
                        <p class="color-text-a">
                          Phòng trọ luôn chất lượng đảm bảo đúng sự thật và
                          không các chi tiết khiến người dùng thất vọng khi đến
                          xem và kiểm tra Phòng trọ. An ninh tuyệt đối.
                        </p>
                          ...
                          <>
                            {showCommentForm ? (
                              <Form onSubmit={this.handleSubmitComment}>
                                ...
                                <h1></h1>
                                <Form.TextArea
                                  label="Chất lượng nhà Phòng trọ"
