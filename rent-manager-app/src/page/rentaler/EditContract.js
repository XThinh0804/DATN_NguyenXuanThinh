...
function EditContract(props) {
  ...
  const handleSubmit = (event) => {
    ...
    if (contractData.isInvoice === true) {
      contractData?.files &&
      ...
      ContractService.editContractInfoOrder(id, formData)
        .then((response) => {
          toast.success(response.message);
          toast.success("Cập nhật hợp đồng thành công!!");
        })
                      ...
                      <div className="row">
                        <div className="mb-3">
                          ...
                          <h6 className="card-subtitle text-muted">
                            Tải mẫu hợp đồng để tạo hợp đồng với người thuê và
                            đẩy lên lưu trữ trên hệ thống. Sau đó chuyển sang
                            file .pdf để upload.
