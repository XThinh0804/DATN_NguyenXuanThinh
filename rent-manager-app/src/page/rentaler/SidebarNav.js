...
const SidebarNav = () => {
  return (
    <ul className="sidebar-nav">
      ...
      <li className="sidebar-item">
        <NavLink to="/rentaler/order-room-management" className="sidebar-link">
          <i className="align-middle" data-feather="sliders"></i> <span className="align-middle">Quản lý thanh toán</span>
        </NavLink>
      </li>
      <li className="sidebar-item">
