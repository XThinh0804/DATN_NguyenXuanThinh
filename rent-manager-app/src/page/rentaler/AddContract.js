...
function AddContract(props) {
    ...
    const handleSubmit = (event) => {
        ...
        formData.append('isInvoice', String(true));
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label" htmlFor="locationId">Chọn Phòng trọ</label>
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label" htmlFor="price">Thời Gian Nhận Phòng trọ</label>
                                        <input type="datetime-local" className="form-control" id="price" name="startDate" 
                                        onChange={handleInputChange}
                                        />
                                    </div>
                                    
                                    <div className="mb-3">
                                        <label className="form-label" htmlFor="price">Thời Gian Trả Phòng trọ</label>
                                        <input type="datetime-local" className="form-control" id="price" name="endDate" 
                                        onChange={handleInputChange}
                                        />
                                    </div>
                                    <div className="row">
