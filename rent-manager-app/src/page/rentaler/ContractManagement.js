                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            ...
                            <h6 className="card-subtitle text-muted"> Quản lý hợp đồng của những người thuê Phòng trọ.</h6>
                        </div>
                                            ...
                                            <tr className="odd">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-success">
                                                        <a href={item?.files} target="_blank">Xem</a>
                                                    </button>
                                                </td>
                                                ...
                                                <td>{item?.endDate}</td>
                                                <td style={{ color: "green" }}>{item.room.status === "ROOM_RENT" || item.room.status === "CHECKED_OUT" ? "Đã trả Phòng trọ" : "Đã thuê"}</td>
                                                <td>
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a data-toggle="tooltip" onClick={() => handleExportBill(item.id)} data-placement="bottom" title="Trả Phòng trọ và xuất hóa đơn">                                                
