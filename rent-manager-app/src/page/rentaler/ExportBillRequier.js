...
function ExportBillRequier(props) {
                    ...
                    <div className="container-fluid p-0">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title">Xuất hóa đơn yêu cầu</h5>
                            </div>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label" htmlFor="price">Tên Phòng trọ</label>
  ...
  function exportToExcel(contractData) {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['Tên Hóa Đơn', 'Mô tả', 'Chi Phí', 'Tên Người Thuê', 'Tên Phòng trọ'],
