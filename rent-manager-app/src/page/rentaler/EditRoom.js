    ...
    const handleSubmit = (event) => {
        ...
        RoomService.updateRoom(id, formData)
            .then(response => {
                ...
                toast.success("Cập nhật thông tin Phòng trọ thành công.");
            })
            .catch(error => {
                toast.error((error && error.message) || 'Oops! Có điều gì đó xảy ra. Vui lòng thử lại!');
            });
                    ...
                    <div className="container-fluid p-0">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title">Cập nhật thông tin Phòng trọ</h5>
                            </div>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    <div className="row">
                                        <div className="mb-3 col-md-6">
                                            <label className="form-label" htmlFor="title">Tiều đề Phòng trọ</label>
                                    ...
                                    <div className="card-header">
                                        <h5 className="card-title">Tài sản của Phòng trọ</h5>
                                    </div>
                                    <br />
