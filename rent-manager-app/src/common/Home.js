...
import { getAllAccountRentaler, getAllAccountRentalerForCustomer, getAllRoomOfCustomer } from "../services/fetch/ApiUtils";
...
class Home extends Component {
    ...
    fetchRooms = () => {
        ...
        getAllAccountRentaler(1, 3).then(response => {
            this.setState({
                        ...
                        <div className="row">
                                ...
                                <div className="card-box-c foo">
                                    ...
                                    <div className="card-body-c">
                                        <p className="content-c">
                                            Đảm bảo An Toàn - An Ninh về Phòng trọ được đăng ký cho thuê với người sử dụng,
                                            Đảm bảo an toàn cháy nổ,...
                                            An ninh chặt chẽ, chắc chắn.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="card-box-c foo">
                                    ...
                                    <div className="card-body-c">
                                        <p className="content-c">
                                            Ưu tiên lợi ích khách hàng đặt lên trên hàng đầu.
                                            Các Phòng trọ & Nhà Phòng trọ với mức giá phải chăng.
                                            Cho thuê giá rẻ.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="col-md-4">
                                <div className="card-box-c foo">
                                    ...
                                    <div className="card-body-c">
                                        <p className="content-c">
                                            Chi tiết cách thức thuê Phòng trọ : Dễ dàng, nhanh nhẹn, an toàn, hiệu quả,...
                                            Làm việc gọn gàng,
                            ...
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    ...
                                    <div className="title-link">
                                        <a href="/rental-home">Danh sách bài đăng
                                                    ...
                                                    <div className="card-body-a">
                                                        <div className="price-box d-flex">
                                                            <span className="price-a">
                                                                ...
                                                                {room.status === "CHECKED_OUT" && `Đã trả Phòng trọ | ${room.price.toLocaleString('vi-VN', {
                                                                    style: 'currency',
                                                                    currency: 'VND',
                                                                })}`}
                                                            </span>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    ...
                                    <div className="title-link">
                                        <a href="/angent-grid">Danh sách chủ nhà cho thuê
                                            <span className="bi bi-chevron-right"></span>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div className="testimonials-box">
                                            <div className="row">
                                                ...
                                                <div className="col-sm-12 col-md-6">
                                                    ...
                                                    <div className="testimonials-content">
                                                        <p className="testimonial-text">
                                                            Hạnh phục của tôi là kiếm được một căn Phòng trọ
