                ...
                <div className="intro intro-carousel swiper position-relative">
                    ...
                    <Swiper spaceBetween={30}
                        ...
                        <SwiperSlide className="carousel-item-b swiper-slide" >
                            <div className="swiper-slide carousel-item-a intro-item bg-image" style={{ backgroundImage: `url(assets/img/banner/slide-1.jpg` }}>
                                            ...
                                            <div className="row">
                                                <div className="col-lg-8">
                                                    <div className="intro-body">
                                                        ...
                                                        <h1 className="intro-title mb-4">
                                                            <span className="color-b">2000 </span> Nhà trọ
                                                            <br /> Đã được thuê
                                                        </h1>
                                                        <p className="intro-subtitle intro-price">
                                                            <a href="/rental-home"><span className="price-a">Ngay đây!</span></a>
