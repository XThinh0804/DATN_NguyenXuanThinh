...
export function getAllAccountRentaler(pageNo, pageSize) {
    return request({
        url: API_BASE_URL + "/account/rentaler?pageNo="+pageNo+"&pageSize="+pageSize,
        method: 'GET'
    });
}
...
export function getAllContractOfRentaler(pageNo, pageSize, name) {
    ...
    return request({
        url: API_BASE_URL + "/contract?pageNo="+pageNo+"&pageSize="+pageSize+"&name="+name+"&isInvoice="+true,
        method: 'GET'
    });
}

export function getAllOrderOfRentaler(pageNo, pageSize, name) {
    if(!localStorage.getItem(ACCESS_TOKEN)) {
        return Promise.reject("No access token set.");
    }

    return request({
        url: API_BASE_URL + "/contract?pageNo="+pageNo+"&pageSize="+pageSize+"&name="+name+"&isInvoice="+false,
        method: 'GET'
    });
}
